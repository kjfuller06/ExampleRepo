## This file produces Figure 1 in Churchill et al. 2020. It is a multipanel figure with the following figures imbedded:
# 1a. Raw soil moisture for fescue plots
# 1b. Comparative soil moisture for fescue plots
# 1c. Maximum surface temperature for all plots
# 1d. Minimum surface temperature for all plots

# Multi-panel code ####
tiff(file = paste("Churchill_et_al._2020_Figure1_",sD,"_",eD,".tiff",sep=""), width =1100, height = 1400, units = "px", res = 200)
...
# 1a  ####
# Assign figure height- increments: 0.23125
